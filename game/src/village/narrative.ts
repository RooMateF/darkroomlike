...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    id: "first-weapon",
    check: (s) => s.anyWeapon,
    text: "她拿起削好的武器,掂了掂重量,交到你的手上。『但願用不上。』她頓了頓。『……不,還是帶著吧。』",
  },
  {
    id: "population-10",
  ...
  },
  {
    id: "farm-built",
    check: (s) => s.farmBuilt,
    text: "『種下去的種子就會發芽,』她蹲在田邊,手指按進土裡,『這件事,不管世界變成什麼樣都不會變。』",
  },
  {
    id: "tannery-built",
    check: (s) => s.tanneryBuilt,
    text: "製革場的氣味不算好聞,她卻站在那裡看了很久。『能把獸皮變成皮革的地方,』她看向你露出微笑。『這樣子下次遠征就會更有保障了吧？』",
  },
  {
    id: "smithy-built",
  ...
  },
  {
    ...
    text: "『人手已經足夠了。』她掀開存糧的木蓋,裡面空得能聽見回音。『但如果要出去遠征只靠著現存的糧食可不行,想出去看看的話先開一塊田吧。』",
  },
  {
    ...
    check: (s) => s.populationCap >= 20 && s.farmBuilt,
    text: [
      "『你已經站穩腳步了。』她望向村子外的黑暗,沉默了好一陣,才回過頭來看你『就連我也說不清楚外面到底有什麼。希望你可以代替我踏出第一步。』",
  ...
  },
  {
    ...
    text: "新背包的針腳相當細緻,能看得出編織者的用心。『這樣旅途就有更多保障了呢!』她輕輕地笑著說道。",
  },
  {
    id: "armor-done",
    check: (s) => s.armorDone,
    // 用戶定稿(2026-08 選 B):關心藏在玩笑裡
    text: "她把皮甲的繫帶一條一條替你拉緊,動作輕柔而緩慢,像是在確認每一個結。最後她屈起手指,在胸甲上敲了兩下:『很結實吧?所以——不可以再讓我看到新的傷口了喔。』",
  },
  ...
  },
  {
    ...
    text: "推車的輪軸上了油,一推就滑出去好遠。她追了兩步才把它攔下來,回頭朝你笑:『以後再也不用把撿到的東西忍痛丟在路邊了吧?』",
  },
  {
    id: "steel-cart-done",
