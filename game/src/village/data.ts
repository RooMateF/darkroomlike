...
export const JOBS: JobDef[] = [
  ...
  // 2026-09 用戶定案:生肉 5+木材 5 → 肉乾 1(曾一路從 30/30→15/15 下修,肉乾要當得起礦工伙食與遠征常備糧)
...
export const TRADES: TradeDef[] = [
  ...
  { id: "trade-elixir", get: "elixir", qty: 1, shards: 5, flavor: "小玻璃瓶裡的透明藥劑,瓶身刻著看不懂的小字。", effect: "戰鬥道具:回復 30 HP,解除中毒與流血。", minTrades: 4 },
...
export const CONSUMABLES: ConsumableDef[] = [
  ...
  { id: "coarsebandage", label: "粗布繃帶", cost: { leather: 10, grain: 20 }, yield: 1, requiresBuilding: "tannery", requiresLandmark: "mine", note: "戰鬥中回復 20 HP 並止血; 但是粗糙的材料拖慢了包紮的速度" },
