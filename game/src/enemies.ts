...
export const LV3_BOSS: EnemyDef = {
  ...
  moves: [
    ...
    { id: "slam", label: "重擊", baseCost: 2.2, symbol: "»»»»»", damage: 10 },
  ],
...
export const GUARDIANS: Record<string, EnemyDef> = {
  mine: {
    ...
    moves: [
      ...
      { id: "crush", label: "重壓", baseCost: 2.4, symbol: "»»»»»»", damage: 11 },
    ],
  ...
  observatory: {
    ...
    moves: [
      ...
      { id: "shriek", label: "撲抓", baseCost: 1.7, symbol: "»»»»", damage: 7 },
    ],
  ...
  shrine: {
    ...
    moves: [
      ...
      { id: "pincer", label: "鉗擊", baseCost: 1.7, symbol: "»»»»", damage: 8 },
    ],
